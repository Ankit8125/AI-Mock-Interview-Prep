...
export const interviewer: CreateAssistantDTO = {
  ...
  model: {
    ...
    messages: [
      {
        role: "system",
        content: `You are a professional job interviewer conducting a real-time voice interview with a candidate. Your goal is to assess their qualifications, motivation, and cultural fit for the role.
...
export const dummyInterviews: Interview[] = [
  {
    ...
    level: "Junior",
    questions: ['What is React?', 'What is Node.js?', 'What is MongoDB?'],
    finalized: false,
